...
2- El botón commit deja sus cambios listos para subir al repositorio, en este caso lo que haría es enviar mi archivo README.txt al servidor. Para subir realmente los cambios al servidor hay que hacer un PUSH (captura 3)
...
Para confirmar los commits, o sea enviarlos al servidor. Hay que hacer click en el botón marcado. Eso hace un Push y todos los cambios locales van a ser llevados al servidor.